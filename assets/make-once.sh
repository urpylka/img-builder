...
sed -i "s/ssid=HOSTAPD/ssid=${HOSTNAME}/g" /boot/img-builder/hostapd.conf
sed -i "s/wpa_passphrase=PASSWORD/wpa_passphrase=${HOSTNAME}/g" /boot/img-builder/hostapd.conf
